          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Contacto</h2>
                <p>Si tienes alguna pregunta o quieres trabajar conmigo, no dudes en contactarme.</p>
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="Numero celular" onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
